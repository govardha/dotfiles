...
-- Get the Catppuccin Mocha scheme as a base
local scheme = wezterm.get_builtin_color_schemes()['Catppuccin Mocha']
-- Override just the blue colors we care about
scheme.ansi[5] = '#89b4fa' -- ansi array is 1-indexed in Lua
scheme.brights[5] = '#a6c7ff'
